...
CREATE TABLE IF NOT EXISTS `swdb`.`data_sessions` (
  ...
  `imu1_Y` FLOAT NULL DEFAULT NULL,
  `imu1_P` FLOAT NULL DEFAULT NULL,
  `imu1_R` FLOAT NULL DEFAULT NULL,
  `imu2_Y` FLOAT NULL DEFAULT NULL,
  `imu2_P` FLOAT NULL DEFAULT NULL,
  `imu2_R` FLOAT NULL DEFAULT NULL,
  `imu3_Y` FLOAT NULL DEFAULT NULL,
  `imu3_P` FLOAT NULL DEFAULT NULL,
  `imu3_R` FLOAT NULL DEFAULT NULL,
